...
x0,t0,tend,dt,w,h = 0,0,10,1E-3,7,3.5 #tiempo obtenido
N= round(tend/dt)+1
...
kP, kI, kD=  622.873, 15285.389,0.844
Cr = 1E-6
Re = 1/(Cr*kI)
Rr = kP*Re
Ce = kD/Rr
...
#Colores
clr1 = np.array([80,3,192])/255
clr2 = np.array([171,3,169])/255
clr3 = np.array([255,213,30])/255
